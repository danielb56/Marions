...
export function AuthForm() {
  ...
  return <form action={action} className="space-y-4">
    <div><label htmlFor="email" className="mb-1.5 block text-sm font-semibold text-[#35423f]">Email</label><div className="relative"><Mail className="absolute left-3.5 top-3.5 h-4 w-4 text-[#7c8582]" /><input id="email" name="email" type="email" autoComplete="email" required className="min-h-12 w-full rounded-xl border border-[#d9d4c9] pl-10 pr-3 text-[15px] outline-none focus:border-[#007ba7] focus:ring-3 focus:ring-[#d9eef6]" placeholder="you@company.com.au" /></div></div>
    <div><div className="mb-1.5 flex items-center justify-between"><label htmlFor="password" className="text-sm font-semibold text-[#35423f]">Password</label><a href="/forgot-password" className="text-sm font-semibold text-[#0077a8] hover:underline">Forgot password?</a></div><div className="relative"><LockKeyhole className="absolute left-3.5 top-3.5 h-4 w-4 text-[#7c8582]" /><input id="password" name="password" type="password" autoComplete="current-password" required className="min-h-12 w-full rounded-xl border border-[#d9d4c9] pl-10 pr-3 text-[15px] outline-none focus:border-[#007ba7] focus:ring-3 focus:ring-[#d9eef6]" /></div></div>
